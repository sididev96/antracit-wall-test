      ...
      <div className="container mx-auto px-4 pt-20 relative z-10">
        <div className="max-w-3xl mx-auto text-center stagger-children">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight mb-6">
            See Your Walls <span className="text-anthracite">Transform</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Upload a photo of your space and instantly visualize how our premium
            wall panels will look. Make confident design decisions before you
            buy.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              variant="minimal"
              size="xl"
              className="bg-secondary border-secondary-foreground/10 hover:bg-secondary/80 shadow-sm"
              asChild
            >
              <a href="#catalog">
